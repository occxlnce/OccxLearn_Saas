...
const EditStudentDialog: React.FC<EditStudentDialogProps> = ({ open, onOpenChange, studentId, onStudentUpdated }) => {
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          // Note: Status would typically be part of a user_status table
        })
        .eq('id', studentId);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        ...
        {isLoading ? (
          <div className="py-4">Loading student data...</div>
        ) : (
